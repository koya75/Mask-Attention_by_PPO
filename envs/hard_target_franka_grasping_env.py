...
from .franka_grasping_module.hard_franka import Franka
...
class FrankaGraspingEnv(VectorEnv):
    ...
    def _create_envs(self, spacing, num_per_row):
        ...
        print("target item:", self.target,":",self.target_number)
    ...
    def _pre_physics_step(self, actions):
        ...
        done = self.franka.pre_physics_step(self.actions, self.item.pos)
